    ...
    <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Why Choose Echofex Inc.?</h2>
          <p className="text-xl text-gray-600">Trusted expertise delivering exceptional results</p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="text-center">
            ...
            <p className="text-gray-600">Experience with industry leaders like Compound and Uniswap</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600">We use the latest tools and frameworks in blockchain, DeFi, and AI</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600">From concept to deployment and beyond</p>
          </div>
        </div>
      </div>
    </section>
